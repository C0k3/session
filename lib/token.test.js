...
describe('token', function() {
    ...
    describe('#createRefreshToken()', function() {
        it('should create new token', function() {
            let token = this.token.createRefreshToken(this.userId, this.clientId, 'apiId', process.env.REFRESH_TOKEN_EXPIRATION);
    ...
    describe('#createAccessToken()', function() {
        it('should create new token', function() {
            let token = this.token.createAccessToken(this.userId, this.clientId, 'apiId', process.env.REFRESH_TOKEN_EXPIRATION);
            let decoded = jwt.verify(token, this.secret);
